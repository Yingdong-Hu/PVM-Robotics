...
class ExpertObsActionReplayBuffer(IterableDataset):
    def __init__(self, obses, actions, num_demos):
...
def make_expert_replay_loader(replay_dir, batch_size, num_demos, num_workers, obs_type):
...
def make_expert_obsaction_replay_loader(expert_obs, expert_action, batch_size, num_demos, num_workers):
    iterable = ExpertObsActionReplayBuffer(expert_obs, expert_action, num_demos)
